...
MCP_INVENTORY_AUDIENCE = os.environ.get("MCP_INVENTORY_AUDIENCE", "mcp-inventory")
MCP_INVENTORY_REQUIRED_SCOPE = os.environ.get("MCP_INVENTORY_REQUIRED_SCOPE", "mcp:inventory")
...
class JwksTokenVerifier(TokenVerifier):
    ...
    def __init__(
        ...
        *,
        ...
        audience: str = MCP_INVENTORY_AUDIENCE,
        required_scope: str = MCP_INVENTORY_REQUIRED_SCOPE,
    ) -> None:
